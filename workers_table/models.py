...
class Position(models.Model):
    ...
    args: name: CharField() 
    '''
    name = models.CharField(verbose_name="position", blank=False, max_length=50)
...
class DepartmentHead(models.Model):
    ...
    '''
    # Employee
    head = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name="head", on_delete=models.CASCADE, blank=False)
    department = models.ForeignKey(Department, verbose_name="department", on_delete=models.CASCADE, blank=False)
...
class Control(models.Model):
    ...
    '''
    employee = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.DO_NOTHING, blank=False)
    ...
    status = models.TextField(
        ...
        default=EmployeeStatusChoices.ABSENT
        )
